...
/*======================================
  ...
  n=5   0.220s    over 10 executions 
  n=6   1.351s    over 10 executions
  n=7   1971.720s    over 2 executions
  n=8   676.415s    over 4 executions
  ======================================*/
...
class TourFinder 
{
	...
	if ( moves > Math.pow(sideLength, 2) ) {
	    /* YOUR KODE HERE */
		solved = true;
	}
	...
	//and recursively generate tour possibilities from current pos
	    ...
	    /* YOUR KODE HERE */
		int[] offset = {1, 2, 2, 1, -1, -2, -2, -1};
		
		for(int z = 0; !solved && z < 8; z ++)
			findTour(x + offset[z], y + offset[(z + 14) % 8], moves + 1);
